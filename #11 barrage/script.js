...
function playSideBumpMP3() {
  const sideBumpMP3 = new Audio(
    "https://assets.codepen.io/8292695/bump-side.mp3"
  );
  sound && sideBumpMP3.play();
}

function playSwitchDirectionsMP3() {
  const switchDirectionsMP3 = new Audio(
    "https://assets.codepen.io/8292695/switch-directions.mp3"
  );
  sound && switchDirectionsMP3.play();
}

function playPointMP3() {
  const pointMP3 = new Audio("https://assets.codepen.io/8292695/point.mp3");
  sound && pointMP3.play();
}

function playExplodeMP3() {
  const explodeMP3 = new Audio("https://assets.codepen.io/8292695/explode.mp3");
  sound && explodeMP3.play();
}

function playHighScoreMP3() {
  const highScoreMP3 = new Audio(
    "https://assets.codepen.io/8292695/high-score.mp3"
  );
