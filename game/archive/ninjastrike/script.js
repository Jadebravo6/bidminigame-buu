...
function sendScoreToServer() {
  const apiUrl = 'http://localhost:3000/api/scores';

  // Ajoutez ces lignes pour obtenir le nom du jeu (vous pouvez le définir selon vos besoins).
  const gameName = 'Menja Cut';
  const data = { gameName, score: state.game.score };
...
function endGame() {
  ...
  // Envoi du score au serveur Node.js
  sendScoreToServer(state.game.score);
