...
window.addEventListener('resize', function() {
    // Définir la largeur de la page sur la largeur du viewport
    document.body.style.width = window.innerWidth + 'px';
});



// Fonction pour démarrer le mouvement vers la gauche
function startMoveLeft() {
    dir = "left";
    player.isMovingLeft = true;
}

// Fonction pour arrêter le mouvement vers la gauche
function stopMoveLeft() {
    player.isMovingLeft = false;
}

// Fonction pour démarrer le mouvement vers la droite
function startMoveRight() {
    dir = "right";
    player.isMovingRight = true;
}

// Fonction pour arrêter le mouvement vers la droite
function stopMoveRight() {
    player.isMovingRight = false;
}

// Ajoutez ces écouteurs d'événements pour détecter les interactions tactiles sur les boutons de déplacement
document.getElementById("moveLeftButton").addEventListener("touchstart", function(event) {
    event.preventDefault(); // Empêche le comportement par défaut du touchstart
    startMoveLeft();
});

document.getElementById("moveLeftButton").addEventListener("touchend", function(event) {
    event.preventDefault(); // Empêche le comportement par défaut du touchend
    stopMoveLeft();
});

document.getElementById("moveRightButton").addEventListener("touchstart", function(event) {
    event.preventDefault(); // Empêche le comportement par défaut du touchstart
    startMoveRight();
});

document.getElementById("moveRightButton").addEventListener("touchend", function(event) {
    event.preventDefault(); // Empêche le comportement par défaut du touchend
    stopMoveRight();
});
